...
public class QuickSorted implements ISorter {
     ...
     */
    public <T> RepositoryContract sorted(RepositoryContract sorter, int startIndex, int count, Comparator<? super Contract> comparator) {
     ...
     * @param <T>        parameter
     */
    private <T> void quickSort(RepositoryContract sorter, int startIndex, int endIndex, Comparator<? super Contract> comparator) {
     ...
     * @param <T>        parameter
     */
    private <T> int partition(RepositoryContract sorter, int startIndex, int endIndex, Comparator<? super Contract> comparator) {
        int i = startIndex - 1;
